...
function eraseGift() {
  if ($gameScreen._pictures.length > 0) {
    $gameScreen._pictures.forEach(function (gift) {
      var gid = $gameScreen._pictures.indexOf(gift);
      if (gift != null) {
        if (gift._name === "hop_qua") {
          $gameScreen.erasePicture(gid);
        }
      }
    });
...
function eraseGiftAll() {
  if ($gameScreen._pictures.length > 0) {
    $gameScreen._pictures.forEach(function (pic) {
      var picID = $gameScreen._pictures.indexOf(pic);
      if (pic != null) {
